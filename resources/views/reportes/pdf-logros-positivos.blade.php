...
<head>
    <meta charset="UTF-8">
    <title>Reporte de Logros Positivos</title>
    <style>
...
<body>
    <div class="header">
        <h1>INTELAFIX</h1>
        <h2>Reporte de Logros Positivos</h2>
    ...
    <table>
        ...
        <tbody>
            ...
            @empty
            <tr>
                <td colspan="4" style="text-align: center; padding: 20px; color: #888;">No hay logros positivos registrados</td>
            </tr>
            @endforelse
        </tbody>
    </table>
