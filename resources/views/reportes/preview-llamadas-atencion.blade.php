...
@section('title', 'Reporte de Llamadas de Atención')

@section('content')
<div class="bg-white rounded-lg shadow-xl p-8">
    <div class="flex justify-between items-center mb-6">
        <h1 class="text-3xl font-bold text-gray-800">
            <i class="fas fa-file-pdf text-red-600 mr-3"></i>Reporte de Llamadas de Atención
        </h1>
        <a href="{{ route('reportes.llamadas-atencion.pdf') }}" class="bg-red-600 hover:bg-red-700 text-white font-semibold px-6 py-3 rounded-lg shadow-lg transition duration-200 transform hover:scale-105">
    ...
    <div class="border-2 border-gray-300 rounded-lg p-8 bg-gray-50">
        ...
        <div class="text-center mb-8 pb-6 border-b-2 border-gray-400">
            ...
            <h3 class="text-xl font-semibold text-gray-700">Reporte de Llamadas de Atención</h3>
        ...
        <table class="min-w-full divide-y divide-gray-300 mb-6">
            ...
            <tbody class="bg-white divide-y divide-gray-200">
                ...
                @empty
                <tr>
                    <td colspan="4" class="px-4 py-8 text-center text-gray-500">No hay llamadas de atención registradas</td>
                </tr>
                @endforelse
            </tbody>
        </table>
