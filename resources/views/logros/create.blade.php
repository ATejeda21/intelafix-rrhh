...
@section('title', 'Registrar Logro/Llamada')
    ...
    <div class="bg-white rounded-lg shadow-xl p-8">
        <div class="mb-6">
            <h1 class="text-3xl font-bold text-gray-800">
                <i class="fas fa-plus-circle text-blue-600 mr-3"></i>Registrar Logro o Llamada de Atención
            </h1>
            <p class="text-gray-600 mt-2">Complete el formulario para registrar un nuevo evento</p>
        </div>
        ...
        <form action="{{ route('logros.store') }}" method="POST">
            ...
            <div class="mb-6">
                ...
                <div class="grid grid-cols-2 gap-4">
                    <label class="relative flex items-center p-4 border-2 rounded-lg cursor-pointer transition hover:bg-green-50 {{ old('tipo') == 'Positivo' ? 'border-green-500 bg-green-50' : 'border-gray-300' }}">
                        <input type="radio" name="tipo" value="Positivo" class="mr-3" {{ old('tipo') == 'Positivo' ? 'checked' : '' }} required>
                        <div>
                    ...
                    <label class="relative flex items-center p-4 border-2 rounded-lg cursor-pointer transition hover:bg-red-50 {{ old('tipo') == 'Negativo' ? 'border-red-500 bg-red-50' : 'border-gray-300' }}">
                        <input type="radio" name="tipo" value="Negativo" class="mr-3" {{ old('tipo') == 'Negativo' ? 'checked' : '' }} required>
                        <div>
            ...
            <div class="mb-6">
                ...
                <input type="date" name="fecha_ocurrencia" id="fecha_ocurrencia" value="{{ old('fecha_ocurrencia', date('Y-m-d')) }}" 
